...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> Vibranium_Ore_Placed_Key = registerKey("sapphire_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(FlaettCraft.MODID, name));
    }
